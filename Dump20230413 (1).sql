...
CREATE TABLE `locar` (
  ...
  `codigo_unidadeFK` int NOT NULL DEFAULT '0',
...
CREATE TABLE `possuir_audio` (
  `codigo_idiomaFK` int NOT NULL,
  `codigo_unidadeFK` int NOT NULL,
  PRIMARY KEY (`codigo_idiomaFK`,`codigo_unidadeFK`),
  KEY `fk_possuir_audio_2_idx` (`codigo_unidadeFK`),
  CONSTRAINT `fk_possuir_audio_1` FOREIGN KEY (`codigo_idiomaFK`) REFERENCES `idioma` (`codigo`),
  CONSTRAINT `fk_possuir_audio_2` FOREIGN KEY (`codigo_unidadeFK`) REFERENCES `unidade` (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `possuir_legenda` (
  ...
  CONSTRAINT `fk_possuir_legenda_1` FOREIGN KEY (`codigo_idiomaFK`) REFERENCES `idioma` (`codigo`),
  CONSTRAINT `fk_possuir_legenda_2` FOREIGN KEY (`codigo_unidadeFK`) REFERENCES `unidade` (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-04-13  2:13:03
